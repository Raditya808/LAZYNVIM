...
-- set keymap mode tab ke dir file lain 
-- Pindah ke buffer berikutnya dengan Tab
vim.keymap.set('n', '<Tab>', ':bnext<CR>', { noremap = true, silent = true, desc = 'Next buffer' })

-- Pindah ke buffer sebelumnya dengan Shift+Tab
vim.keymap.set('n', '<S-Tab>', ':bprevious<CR>', { noremap = true, silent = true, desc = 'Previous buffer' })


-- dashboard set home 
-- Buka Dashboard (menggunakan snacks.nvim)
-- space -h cui 
